...
public class GaussianBlurUtils {
    ...
    public static GaussianBlurUtils with(Context context) {
        return new GaussianBlurUtils(context);
    }
     ...
     */
    public GaussianBlurUtils radius(@IntRange(from = MIN_RADIUS, to = MAX_RADIUS) int radius) {
        this.radius = radius;
        return this;
    }
     ...
     */
    public GaussianBlurUtils size(@FloatRange(from = MIN_SIZE, to = MAX_SIZE) float maxSize) {
        this.size = maxSize;
        return this;
    }
